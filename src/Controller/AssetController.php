...
class AssetController extends ControllerBase
{
    ...
    {
        return new static($container->get('file_system'), $container->get('grapesjs_editor.asset_manager'));
    }
     ...
     *        
     * @throws \Drupal\Core\Entity\EntityStorageException Thrown if the storage can't be found.
     */
